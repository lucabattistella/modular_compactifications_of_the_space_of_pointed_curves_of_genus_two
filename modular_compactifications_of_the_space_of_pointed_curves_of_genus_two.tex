...
\begin{thm}
 For every $1\leq m <n$, $m$-stability defines a proper Deligne-Mumford stack $\oM_{2,n}^{(m)}$ over $\k$, containing $\pazocal M_{2,n}$ as a dense open substack.
\end{thm}
