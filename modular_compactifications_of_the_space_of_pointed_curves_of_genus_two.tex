...
\begin{proof}(of Proposition \ref{prop:contractionI})
 By blowing down some rational tails, we can assume that $\mathcal C_0\setminus Z=\sqcup_{i=1}^m T_i$ with each $T_i\simeq\PP^1$.
\end{proof}
