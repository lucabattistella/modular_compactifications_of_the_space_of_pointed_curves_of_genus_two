...
\email{battistella@mpim-bonn.mpg.de}
...
\begin{enumerate}[leftmargin=.7cm]
 \item Resolve the indeterminacy of the rational map $\oM_{2,n}^{(m_1)}\dashrightarrow\oM_{2,n}^{(m_2)}$, and study the intersection theory of these spaces; we expect the construction to rely on a semistable compactification of the crimping spaces of the genus two singularities, as in \cite[\S 1.10]{vdW} and \cite{SMY3}, as well as on logarithmic geometry, as in \cite{RSPW1}. The study of the Picard group and the projectivity of the coarse moduli space will firmly site this work in the context of the Hassett-Keel program, as in \cite{SMY2}; we hope similar techniques to \cite{AFS1} and \cite{CTV1} will apply.
...
\end{lem}
\begin{proof}
 Let $K(\tilde C)$ denote the constant sheaf of rational functions on $\tilde C$. A section of $\Omega_{\tilde C}^\vee\otimes K(\tilde C)$ is contained in $\Omega_C^\vee$ if and only if its image under the push-forward
 \[\nu_*\colon\nu_*\hhom(\Omega_{\tilde C},K(\tilde C))\to \hhom(\Omega_C,K(\tilde C)) \]
 lies in the subspace $\hhom(\Omega_C,\OO_C)$. We may work locally around the singular point in the coordinates we found in Section \ref{sec:sing}.
...
\begin{rem}\label{rmk:Wandconj}
 ...
 \begin{itemize}[leftmargin=.5cm]
  ...
  \begin{center}
  \begin{figure}[!ht]
  \includegraphics[width=.8\textwidth]{admissible_Weierstrass}
...
\newblock {\em arXiv e-prints}, page arXiv:1801.07739, Jan 2018.
...
\newblock {\em arXiv e-prints}, page arXiv:1808.00231, Aug 2018.

\bibitem[CTV19]{CTV2}
Giulio {Codogni}, Luca {Tasin}, and Filippo {Viviani}.
\newblock {On some modular contractions of the moduli space of stable pointed
  curves}.
\newblock {\em arXiv e-prints}, page arXiv:1904.13212, Apr 2019.
...
\newblock {\em arXiv e-prints}, page arXiv:1805.08581, May 2018.
...
\newblock {\em arXiv e-prints}, page arXiv:1411.0627, Nov 2014.
...
\newblock {\em arXiv e-prints}, page arXiv:1201.2427, Jan 2012.
...
\newblock {\em arXiv e-prints}, page arXiv:1807.09746, Jul 2018.
...
\newblock {\em arXiv e-prints}, page arXiv:1511.03797, Nov 2015.
...
\newblock {\em arXiv e-prints}, page arXiv:1708.02359, August 2017.

\bibitem[RSW17b]{RSPW2}
Dhruv {Ranganathan}, Keli {Santos-Parker}, and Jonathan {Wise}.
\newblock {Moduli of stable maps in genus one and logarithmic geometry II}.
\newblock {\em arXiv e-prints}, page arXiv:1709.00490, September 2017.
...
\newblock {\em arXiv e-prints}, page arXiv:1808.03214, Aug 2018.
